...
function getFahrenheit() {
    ...
    document.getElementById("temp").innerText = (getWeatherInCity.temperatureInKelvin) - 457.87;
}
function getCelsius() {
    var list = document.getElementById("list");
    var selectedCityFromList = list.options[list.selectedIndex].value;
    ...
    document.getElementById("temp").innerText = weatherInSelectedCity.temperatureInKelvin - 273.15;
}
